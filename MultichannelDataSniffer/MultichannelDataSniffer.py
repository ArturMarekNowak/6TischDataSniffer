...
class MultichannelDataSniffer(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.rtlsdr_source_0.set_center_freq(863.2e6, 1)
        ...
        self.rtlsdr_source_0.set_gain(0, 1)
        self.rtlsdr_source_0.set_if_gain(10, 1)
        self.rtlsdr_source_0.set_bb_gain(10, 1)
        ...
        # Connections
        ##################################################
        self.connect((self.rtlsdr_source_0, 0), (self.qtgui_waterfall_sink_x_0_0_0, 0))
        self.connect((self.rtlsdr_source_0, 1), (self.qtgui_waterfall_sink_x_0_0_0_0, 0))

...
class fsk_demod(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "fsk_demod")
        ...
        self.center_freq = center_freq = 1500
...
def main(top_block_cls=fsk_demod, options=None):

...
class options_0(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.rtlsdr_source_0.set_center_freq(863.04e6, 0)
        ...
        self.digital_packet_sink_0 = digital.packet_sink([0,0], gr.msg_queue(1), -1)
        self.analog_quadrature_demod_cf_0 = analog.quadrature_demod_cf(44)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_quadrature_demod_cf_0, 0), (self.digital_packet_sink_0, 0))

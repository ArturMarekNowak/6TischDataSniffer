...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.filterFIR = filterFIR =  firdes.low_pass(1,samp_rate,100000,5000)
        ...
        self.rtlsdr_source_0.set_center_freq(866.4e6, 0)
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_0_1_0_0_win)
        ...
        self.freq_xlating_fir_filter_xxx_0_0_0 = filter.freq_xlating_fir_filter_ccc(1, filterFIR, 2000000, samp_rate_divide)
        self.freq_xlating_fir_filter_xxx_0_0 = filter.freq_xlating_fir_filter_ccc(1, filterFIR, -600000, samp_rate_divide)
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_ccc(1, filterFIR, -2000000, samp_rate_divide)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_quadrature_demod_cf_0_0, 0), (self.qtgui_time_sink_x_0_1, 0))
        self.connect((self.analog_quadrature_demod_cf_0_0_0, 0), (self.qtgui_time_sink_x_0_1_0, 0))
        self.connect((self.analog_quadrature_demod_cf_0_0_0_0, 0), (self.qtgui_time_sink_x_0_1_0_0, 0))
        ...
        self.connect((self.freq_xlating_fir_filter_xxx_0_0, 0), (self.analog_quadrature_demod_cf_0_0_0, 0))
        self.connect((self.freq_xlating_fir_filter_xxx_0_0, 0), (self.qtgui_waterfall_sink_x_0_0, 0))
        self.connect((self.freq_xlating_fir_filter_xxx_0_0_0, 0), (self.analog_quadrature_demod_cf_0_0_0_0, 0))
        self.connect((self.freq_xlating_fir_filter_xxx_0_0_0, 0), (self.qtgui_waterfall_sink_x_0_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_filterFIR( firdes.low_pass(1,self.samp_rate,100000,5000))

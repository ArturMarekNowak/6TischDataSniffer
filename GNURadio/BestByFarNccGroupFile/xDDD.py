...
class xDDD(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.number_of_samples = number_of_samples = 12000
        ...
        self.qtgui_time_sink_x_1_0 = qtgui.time_sink_f(
            ...
            samp_rate, #samp_rate
            "DIgital before descrambling", #name
            1 #number of inputs
        )
        ...
        self.digital_descrambler_bb_0 = digital.descrambler_bb(0x11, 0x01, 9)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, 'C:\\Users\\artur\\OneDrive\\Desktop\\6TSCHv3.raw', True, 0, 0)
        ...
        self.connect((self.analog_quadrature_demod_cf_0, 0), (self.blocks_stream_to_tagged_stream_0, 0))
        ...
        self.connect((self.digital_descrambler_bb_0, 0), (self.blocks_uchar_to_float_0_0, 0))
